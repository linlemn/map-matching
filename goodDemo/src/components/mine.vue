                    ...
                    <div class="uk-card-body">
                        <ul class="uk-list uk-list-divider">
                            <li v-for="des in Destinations">
                                <a class="uk-link-reset"><p class="li-p">{{des.title}}<i class="fa fa-angle-right" style="color: white; position: relative; left:20%;"></i></p></a>
                            </li>
                        </ul>
                    </div>               
                </div>
...
export default {
  ...
  data() {
    return {
      ...
      Destinations: [{title: '同济大学嘉定校区'}, {title: '同济大学嘉定校区'}, {title: '同济大学嘉定校区'}],
      Paths: [],
      Hotspot: [],
      Historys: [],
