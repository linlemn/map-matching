      ...
      <div class="settings"></div>
            <ul>
                ...
                <li>
                    <a href="#">
                        <i class="fa fa-t"></i>
                        <p5 style="font-size: 7px;">(1-1000000)</p5>
                    </a>
                </li>
                ...
                <li>
                    <a href="#"> 
                        <i class="fa fa-t"></i>
                            <input type="button" id="range" value="提交" @onclick="range();" style="width:70px; height: 23px; font:7px; text-align:center"/>
                    </a>
                </li>
...
export default {
  ...
  methods: {
    ...
    range: function() {
      if (this.resultArr.length==0){
            ...
            else if (lowValue>10000000||highValue>10000000||lowValue<0||highValue<0) {
  ...
  this.center = [this.resultArr[low_limit][1], this.resultArr[low_limit][2]];
  this.zoom = 13
  ...
  for(var i=low_limit;i<limit-1;i++){
    ...
    ], {color: 'yellow', dashArray: '5, 10'}).addTo(this.$refs.map.mapObject).bindPopup("I am a projection.");
      L.circle([this.resultArr[i][1], this.resultArr[i][2]], 0.4, {
          color: 'red',
          fillColor: 'red',
          fillOpacity: 1
      }).addTo(this.$refs.map.mapObject).bindPopup("I am a point.");
  }
},
  ...
  for(var i=low_limit; i<limit-1; i++){
    ...
    //   console.log(test.edgeGeometry[sid]);
      ...
      var arrowHead = L.polylineDecorator(arrow, {
          patterns: [
              {offset: '100%', repeat: 0, symbol: L.Symbol.arrowHead({pixelSize: 7, polygon: false, pathOptions: {stroke: true}})}
...
@import "../css/set1.css";
    ...
    input#quantity_low, input#quantity_high{
        height: 15px;
        width: 50px;
        border:1px;
        /* text-align: center; */
